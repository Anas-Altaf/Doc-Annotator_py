...
class AppConfig:
    ...
    1. The exact category name from the list above, No other category, You must to choose one of them, if not matches, choose one of that is near to that paper, Just Name Text, No symbols etc,
